...
<div class="lil-row center">
    <div class="lil-col md-10-12 lg-8-12 xl-9-12">
        <div class="user-banner" style="background-image: url('/storage/banners/{{ $user->banner }}')">
            <div class="user-avatar" style="background-image: url('/storage/avatars/{{ $user->avatar }}')"></div>
        </div>
    </div>
</div>
